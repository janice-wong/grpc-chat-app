...
namespace GreeterServer.Tests
{
  public class ChatValidatorTest
  {
    ...
    {
      var message = "this is less than 100 characters";
      var result = ChatValidator.ValidateMessageCharLimit(message);
    ...
    {
      var message = "this is 101 characters this is 101 characters this is 101 characters this is 101 characters this is 1";
      var result = ChatValidator.ValidateMessageCharLimit(message);
